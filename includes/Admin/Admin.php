...
class BeThemeSmartSearch_Admin {
    ...
    public function post_types_callback() {
        ...
        $post_types = isset($options['post_types']) ? $options['post_types'] : $defaults['post_types'];
    ...
    public function search_fields_callback() {
        $options = BeThemeSmartSearch_Support_Options::get();
        $defaults = BeThemeSmartSearch_Support_Options::get_default_options();
        $search_fields = isset($options['search_fields']) ? $options['search_fields'] : $defaults['search_fields'];
    ...
    public function preserve_betheme_search_callback() {
        $options = BeThemeSmartSearch_Support_Options::get();
        $defaults = BeThemeSmartSearch_Support_Options::get_default_options();
        $preserve = isset($options['preserve_betheme_search']) ? $options['preserve_betheme_search'] : $defaults['preserve_betheme_search'];
    ...
    public function field_weights_callback() {
        $options = BeThemeSmartSearch_Support_Options::get();
        $defaults = BeThemeSmartSearch_Support_Options::get_default_options();
        $default_weights = isset($defaults['field_weights']) && is_array($defaults['field_weights'])
            ? $defaults['field_weights']
            : array(
                'title' => 5,
                'sku' => 10,
                'content' => 1,
            );
        $weights = isset($options['field_weights']) ? $options['field_weights'] : $default_weights;
    ...
    public function live_search_callback() {
        ...
        $enabled = isset($options['live_search_enabled']) ? $options['live_search_enabled'] : $defaults['live_search_enabled'];
        $debounce = isset($options['live_search_debounce']) ? $options['live_search_debounce'] : $defaults['live_search_debounce'];
        $max_results = isset($options['live_search_max_results']) ? $options['live_search_max_results'] : $defaults['live_search_max_results'];
        $show_categories = isset($options['live_search_show_categories']) ? $options['live_search_show_categories'] : $defaults['live_search_show_categories'];
        $show_brands = isset($options['live_search_show_brands']) ? $options['live_search_show_brands'] : $defaults['live_search_show_brands'];
        $show_code_products = isset($options['live_search_show_code_products']) ? $options['live_search_show_code_products'] : $defaults['live_search_show_code_products'];
        $show_suggestions = isset($options['live_search_show_suggestions']) ? $options['live_search_show_suggestions'] : $defaults['live_search_show_suggestions'];
        $code_match_mode = isset($options['code_match_mode']) ? $options['code_match_mode'] : $defaults['code_match_mode'];
        ...
        echo '</tr>';
        echo '<tr>';
        echo '<th scope="row">' . __('Show Code Matches', 'betheme-smart-search') . '</th>';
        echo '<td><input type="checkbox" name="' . $this->option_name . '[live_search_show_code_products]" value="1" ' . checked(1, $show_code_products, false) . ' /></td>';
        echo '</tr>';
        echo '<tr>';
        echo '<th scope="row">' . __('Show Suggestions While Typing', 'betheme-smart-search') . '</th>';
        echo '<td><input type="checkbox" name="' . $this->option_name . '[live_search_show_suggestions]" value="1" ' . checked(1, $show_suggestions, false) . ' /></td>';
        echo '</tr>';
        echo '<tr>';
        echo '<th scope="row">' . __('Code Match Mode', 'betheme-smart-search') . '</th>';
        echo '<td>';
        echo '<select name="' . $this->option_name . '[code_match_mode]">';
        echo '<option value="contains"' . selected($code_match_mode, 'contains', false) . '>' . __('Contains', 'betheme-smart-search') . '</option>';
        echo '<option value="startswith"' . selected($code_match_mode, 'startswith', false) . '>' . __('Starts with', 'betheme-smart-search') . '</option>';
        echo '<option value="exact"' . selected($code_match_mode, 'exact', false) . '>' . __('Exact', 'betheme-smart-search') . '</option>';
        echo '</select>';
        echo '</td>';
        echo '</tr>';
        echo '</table>';
    ...
    public function template_settings_callback() {
        $options = BeThemeSmartSearch_Support_Options::get();
        $defaults = BeThemeSmartSearch_Support_Options::get_default_options();
        $use_custom = isset($options['use_custom_template']) ? $options['use_custom_template'] : $defaults['use_custom_template'];
    ...
    public function results_layout_page_callback() {
        $options = BeThemeSmartSearch_Support_Options::get();
        $defaults = BeThemeSmartSearch_Support_Options::get_default_options();
        $page_id = isset($options['results_layout_page_id']) ? absint($options['results_layout_page_id']) : $defaults['results_layout_page_id'];
    ...
    public function enable_caching_callback() {
        $options = BeThemeSmartSearch_Support_Options::get();
        $defaults = BeThemeSmartSearch_Support_Options::get_default_options();
        $enabled = isset($options['enable_caching']) ? $options['enable_caching'] : $defaults['enable_caching'];
    ...
    public function cache_ttl_callback() {
        $options = BeThemeSmartSearch_Support_Options::get();
        $defaults = BeThemeSmartSearch_Support_Options::get_default_options();
        $ttl = isset($options['cache_ttl']) ? $options['cache_ttl'] : $defaults['cache_ttl'];
    ...
    public function ajax_test_search() {
        ...
        $rest = new BeThemeSmartSearch_Rest_Query();
